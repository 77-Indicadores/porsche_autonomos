...
from app.routers import alocacoes, auth, cadastros, dashboard, relatorios, usuarios, referencias_importacao, pesquisas, equipe_geral, dho, facilities, composicao_meta_equipe, budget, folha_centros_custo, folha_export_liquidos, folha_movimentacoes, indicadores_pesquisas, super77, folha_variacao
...
app.include_router(folha_centros_custo.router)
app.include_router(folha_export_liquidos.router)
app.include_router(folha_movimentacoes.router)
...
app.include_router(folha_variacao.router)
