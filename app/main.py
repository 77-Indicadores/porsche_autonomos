...
from app.routers import alocacoes, auth, cadastros, dashboard, relatorios, usuarios, referencias_importacao, pesquisas, equipe_geral, dho, facilities, composicao_meta_equipe, budget, export
