...
from app.routers import alocacoes, auth, cadastros, dashboard, relatorios, usuarios, referencias_importacao, pesquisas, composicao_padrao, composicao_meta_equipe, equipe_geral, dho, facilities
