...
composicao_padrao_equipe = Table(
    ...
    Column("id_cargo_autonomo", Integer, nullable=False),
    Column("qtd_esperada", Integer, nullable=False, default=1),
    Column("custo_medio_esperado", Float, nullable=True),
    Column("status", String(30), nullable=False, default="Ativo"),
