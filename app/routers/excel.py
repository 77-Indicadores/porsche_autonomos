...
FIELD_HINTS = {
    ...
    "data_inicio_vinculo": "Data de início do vínculo. Formato DD/MM/AAAA ou AAAA-MM-DD. Se em branco, usa a data de hoje.",
    "data_fim_vinculo": "Data de fim do vínculo. Formato DD/MM/AAAA ou AAAA-MM-DD. Deixe em branco se o vínculo ainda está ativo.",
    "forma_pagamento": "Forma de pagamento. Exemplos: PIX, Boleto, Transferência Bancária, Dinheiro.",
