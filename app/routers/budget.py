...
def _seed_regras_budget(db: Session):
    ...
    regras = [
        ...
        dict(
            codigo="APOIO_ETAPA",
            descricao="Apoiador Etapa - lista padrão",
            categoria="adicional",
            tipo_calculo="percentual",
            percentual=0.15,
            condicoes_json=json.dumps([
                {"campo": "nome", "operador": "igual", "valor": "DANIEL DOS SANTOS SILVA"},
                {"campo": "nome", "operador": "igual", "valor": "ROMULO PINTO DE OLIVEIRA REIS"},
                {"campo": "nome", "operador": "igual", "valor": "YURI AMANCIO GONÇALVES"},
                {"campo": "nome", "operador": "igual", "valor": "LUCIANO SANTIAGO ANTENOR"},
            ], ensure_ascii=False),
            prioridade=10,
        ),
        dict(
            codigo="APOIO_ETAPA",
            descricao="Apoiador Etapa - José até 12/2025",
            categoria="adicional",
            tipo_calculo="percentual",
            percentual=0.15,
            condicoes_json=json.dumps([
                {"campo": "nome", "operador": "igual", "valor": "JOSE DEIVID REIS DOS SANTOS"},
            ], ensure_ascii=False),
